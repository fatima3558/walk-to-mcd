...
from walk_to_mcd.logging import before_send
...
WSGI_APPLICATION = 'walk_to_mcd.wsgi.application'
...
DATABASES['default'] = dj_database_url.parse(
    os.getenv('DATABASE_URL', 'postgres://postgres:postgres@postgres:5432/walk-to-mcd-db'),
    conn_max_age=600,
